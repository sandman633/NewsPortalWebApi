...
namespace Repositories.Implementations
{
        ...
        where TContext : DbContext
    {
        ...
        //public ICrudRepository<T,TDto> GetRepository<T, TDto>() where T : class
        //    where TDto : class
        //{
        ...
        //    {
        //        _repositories[type] = DbContext.GetService<TRepositoryImplementation>(); 
        //    }
            ...
            where TRepoInterface : class, ICrudRepository<TDto, TEntity> 
        {
            ...
            {
                _repositories[t] = DbContext.GetService<TRepoInterface>();
            }

            return (TRepoInterface)_repositories[t];
        }
        /// <summary>
